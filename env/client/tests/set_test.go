...
func execSetTest(t *testing.T, stdin io.WriteCloser, stdout io.ReadCloser) {
	cmd := [...]string{"admin\n", "admin\n", "set pic1.jpg\n", "exit\n"}
	...
	outputRoutine(t, reader, '\n', "Reading pic1.jpg.\n")
	outputRoutine(t, reader, '\n', "Successfully Sent pic1.jpg.\n")
	outputRoutine(t, reader, ' ', "> ")
	sendInput(t, stdin, cmd[3])
}

func TestSetFile(t *testing.T) {
	os.Remove("/opt/shared/pic1.jpg")
	...
	ogFile := hashFile(t, "/opt/client/pic1.jpg")
	setFile := hashFile(t, "/opt/shared/pic1.jpg")
	if ogFile != setFile {
